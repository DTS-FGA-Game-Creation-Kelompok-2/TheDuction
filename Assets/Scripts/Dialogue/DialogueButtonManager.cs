...
namespace TheDuction.Dialogue{
    public class DialogueButtonManager : SingletonBaseClass<DialogueButtonManager> {
        ...
        /// <summary>
        /// Hide the dialogue elements to show the environment only
        /// </summary>
        public void HideDialogue(){
            StartCoroutine(AlphaFadingEffect.FadeOut(dialogueElementsCanvasGroup,
                beforeEffect: () => {
        ...
        private void ShowDialogue(){
            StartCoroutine(AlphaFadingEffect.FadeIn(dialogueElementsCanvasGroup,
                afterEffect: () => {
